    ...
    <x-admin-modal id="create-tenant-modal" title="Create New Tenant" size="lg">
        <form method="POST" action="{{ route('admin.tenants.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <x-admin-form-input name="email" label="Email" type="email" required placeholder="admin@example.com" />
            </div>
            
            <x-admin-form-input name="database" label="Database Name" required placeholder="tenant_db_name" />
