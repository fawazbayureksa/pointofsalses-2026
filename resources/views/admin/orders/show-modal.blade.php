        ...
        <div class="space-y-6">
                        ...
                        <tbody class="text-sm">
                            @foreach ($order->items ?? [] as $item)
                                <tr class="border-t border-gray-200">
                                    ...
                                    <td class="py-2">Rp {{ number_format($item->unit_price ?? 0, 0, ',', '.') }}</td>
                                    <td class="py-2">{{ $item->quantity ?? 0 }}</td>
                                    <td class="py-2">Rp {{ number_format($item->subtotal ?? 0, 0, ',', '.') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-lg font-semibold">{{ ucfirst($order->payment?->payment_method ?? '-') }}</p>
                </div>
                <div>
