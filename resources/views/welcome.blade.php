...
<head>
    ...
    <style>
        * {
        ...
        .animate-slide-up-4 {
            animation: slide-up 0.7s 0.45s ease both;
        }
    ...
    <nav id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-4 px-6">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center gap-8">
                ...
                <a href="{{ route('docs') }}" class="text-sm text-slate-400 hover:text-white transition-colors">Docs</a>
            </div>
            ...
            <div class="hidden md:flex items-center gap-3">
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="btn-secondary text-sm text-slate-300 font-medium px-5 py-2.5 rounded-xl">
                        Sign In
                    </a>
        ...
        <div id="mobile-menu" class="md:hidden glass-dark mx-0 mt-3 rounded-2xl">
            <div class="p-5 flex flex-col gap-3">
                <a href="#features"
                    class="text-sm text-slate-300 hover:text-white py-2 border-b border-white/5">Features</a>
                <a href="#modules"
                    class="text-sm text-slate-300 hover:text-white py-2 border-b border-white/5">Modules</a>
                <a href="#pricing"
                    class="text-sm text-slate-300 hover:text-white py-2 border-b border-white/5">Pricing</a>
                <a href="#download"
                    class="text-sm text-slate-300 hover:text-white py-2 border-b border-white/5">Download</a>
                <a href="{{ route('docs') }}"
                    class="text-sm text-slate-300 hover:text-white py-2 border-b border-white/5">Docs</a>
                <div class="flex gap-3 pt-2">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="btn-secondary text-sm text-slate-300 font-medium px-5 py-2.5 rounded-xl flex-1 text-center">Sign
                            In</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}"
                                class="btn-primary text-white text-sm font-semibold px-5 py-2.5 rounded-xl flex-1 text-center">Get
                                Started</a>
                        @endif
                    @endauth
                </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 w-full">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <!-- Headline -->
                    <h1
                        class="animate-slide-up-2 text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.05] tracking-tight mb-6">
                    ...
                    <div class="animate-slide-up-4 flex flex-wrap gap-4 mb-12">
                        ...
                        @else
                            ...
                            @endif
                            <a href="{{ route('login') }}"
                                class="btn-secondary text-slate-300 font-medium px-8 py-4 rounded-2xl text-base flex items-center gap-2">
                ...
                <div class="relative bounce-subtle hidden lg:block">
                    <!-- Outer glow -->
                    <div
                        class="absolute inset-0 bg-gradient-to-br from-indigo-500/20 to-violet-500/10 rounded-3xl blur-3xl scale-105">
                    </div>
                    ...
                    <div class="relative glass-dark rounded-3xl overflow-hidden shadow-2xl shadow-indigo-900/40">
                        ...
                        <div class="flex items-center gap-2 px-5 py-4 border-b border-white/5">
                            ...
                            <div class="flex-1 text-center">
                                <span class="text-xs text-slate-500 font-mono">{{ config('app.name') }} —
                                    Dashboard</span>
                            </div>
                        </div>
                        ...
                        <div class="p-5 space-y-4">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <div class="glass rounded-2xl p-4">
                                    ...
                                    <p class="text-xs text-emerald-400 mt-1"><i class="fas fa-arrow-up"></i> +12.4%
                                    </p>
                                </div>
                                <div class="glass rounded-2xl p-4">
                                ...
                                <div class="glass rounded-2xl p-4">
                                    ...
                                    <p class="text-xs text-amber-400 mt-1"><i class="fas fa-exclamation-triangle"></i>
                                        Low stock</p>
                                </div>
                            </div>
                            ...
                            <div class="glass rounded-2xl p-4">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center justify-between text-xs">
                                        ...
                                        <span
                                            class="px-2 py-0.5 rounded-full bg-emerald-500/15 text-emerald-400">Paid</span>
                                    </div>
                                    <div class="flex items-center justify-between text-xs">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-6 h-6 rounded-lg bg-indigo-500/20 flex items-center justify-center">
                                                <i class="fas fa-receipt text-indigo-400" style="font-size:9px"></i>
                                            </div>
                                            <span class="text-slate-400">ORD-20260002</span>
                                        </div>
                                        <span class="text-white font-medium">Rp 87,500</span>
                                        <span
                                            class="px-2 py-0.5 rounded-full bg-amber-500/15 text-amber-400">Pending</span>
                                    </div>
                                    <div class="flex items-center justify-between text-xs">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-6 h-6 rounded-lg bg-violet-500/20 flex items-center justify-center">
                                                <i class="fas fa-receipt text-violet-400" style="font-size:9px"></i>
                                            </div>
...
============================= -->
    <section class="py-20 bg-[#060b18]">
        <div class="max-w-7xl mx-auto px-6">
            <!-- Logos row -->
            <p class="text-center text-xs font-semibold tracking-widest text-slate-600 uppercase mb-10">Trusted by
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                <div class="reveal inline-flex items-center gap-2 glass rounded-full px-4 py-2 mb-4">
                    ...
                    <span class="text-xs font-semibold text-indigo-300 uppercase tracking-widest">Everything You
                        Need</span>
                </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Lightning-fast checkout experience with barcode
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Real-time stock tracking with automatic
                        deductions on every sale. Transfer stock between outlets, set reorder points, and never run out.
                    </p>
                    <div class="mt-4 flex gap-2 flex-wrap">
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Comprehensive financial reports, revenue
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Manage unlimited store locations from a single
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Granular access control with custom roles. Assign
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">Fully isolated tenant environments. Perfect for
                        franchise owners, holding companies, or white-label resellers. One platform, many businesses.
                    </p>
                    <div class="mt-4 flex gap-2 flex-wrap">
    ...
    <section id="modules" class="py-24 bg-[#060b18]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="reveal text-slate-400 text-lg max-w-xl mx-auto">All modules are deeply integrated — data
            ...
            <div class="grid lg:grid-cols-2 gap-8 items-center mb-16">
                ...
                <div class="space-y-4">
                    <div
                        class="reveal-left glass-dark rounded-2xl p-5 flex items-start gap-4 card-hover cursor-pointer border border-indigo-500/30">
                        <div
                            class="w-12 h-12 rounded-2xl bg-indigo-500/20 flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-cash-register text-indigo-400 text-xl"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-white mb-1">POS Module</h3>
                            <p class="text-sm text-slate-400">Cashier interface, order management, payment processing,
                    ...
                    <div class="reveal-left glass rounded-2xl p-5 flex items-start gap-4 card-hover cursor-pointer">
                        <div
                            class="w-12 h-12 rounded-2xl bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-warehouse text-emerald-400 text-xl"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-white mb-1">Inventory Module</h3>
                            <p class="text-sm text-slate-400">Stock tracking, movement history, adjustments,
                    ...
                    <div class="reveal-left glass rounded-2xl p-5 flex items-start gap-4 card-hover cursor-pointer">
                        <div
                            class="w-12 h-12 rounded-2xl bg-violet-500/20 flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-file-invoice-dollar text-violet-400 text-xl"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-white mb-1">Finance Module</h3>
                            <p class="text-sm text-slate-400">Revenue tracking, expense management, profit & loss
                    ...
                    <div class="reveal-left glass rounded-2xl p-5 flex items-start gap-4 card-hover cursor-pointer">
                        <div
                            class="w-12 h-12 rounded-2xl bg-amber-500/20 flex items-center justify-center flex-shrink-0">
                            <i class="fas fa-chart-bar text-amber-400 text-xl"></i>
                        </div>
                        <div>
                            <h3 class="font-bold text-white mb-1">Reporting Module</h3>
                            <p class="text-sm text-slate-400">Detailed sales, inventory, and staff reports. Filter by
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="h-2 rounded-full bg-white/5 overflow-hidden">
                                <div class="progress-bar h-full rounded-full bg-gradient-to-r from-indigo-500 to-violet-500"
                                    style="--fill:98%"></div>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="h-2 rounded-full bg-white/5 overflow-hidden">
                                <div class="progress-bar h-full rounded-full bg-gradient-to-r from-violet-500 to-pink-500"
                                    style="--fill:95%"></div>
                            </div>
                        </div>
                        <div>
    ...
    <section class="py-24 bg-[#070c1b]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="reveal text-slate-400 text-lg">No lengthy onboarding. No IT team required. Start selling in
                    minutes.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 relative">
                <!-- Step connector line -->
                <div
                    class="hidden md:block absolute top-14 left-1/3 right-1/3 h-0.5 bg-gradient-to-r from-indigo-500 via-violet-500 to-emerald-500 opacity-40">
                </div>

                <div class="reveal text-center">
                    <div
                        class="w-28 h-28 rounded-3xl bg-gradient-to-br from-indigo-600 to-indigo-800 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-indigo-900/40 relative">
                        <i class="fas fa-building text-white text-3xl"></i>
                        <div
                            class="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-indigo-500 flex items-center justify-center text-white text-xs font-black">
                            1</div>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-3">Create Your Account</h3>
                    <p class="text-slate-400 text-sm leading-relaxed">Register your business, add your outlets, and
                        configure your product catalog. Takes under 5 minutes.</p>
                </div>

                <div class="reveal text-center">
                    <div
                        class="w-28 h-28 rounded-3xl bg-gradient-to-br from-violet-600 to-violet-800 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-violet-900/40 relative">
                        <i class="fas fa-sliders-h text-white text-3xl"></i>
                        <div
                            class="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-violet-500 flex items-center justify-center text-white text-xs font-black">
                            2</div>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-3">Configure & Invite Team</h3>
                    <p class="text-slate-400 text-sm leading-relaxed">Set roles, assign staff to outlets, and configure
                        payment methods. Customize to fit your workflow.</p>
                </div>

                <div class="reveal text-center">
                    <div
                        class="w-28 h-28 rounded-3xl bg-gradient-to-br from-emerald-600 to-emerald-800 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-emerald-900/40 relative">
                        <i class="fas fa-rocket text-white text-3xl"></i>
                        <div
                            class="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center text-white text-xs font-black">
                            3</div>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-3">Start Selling</h3>
                    <p class="text-slate-400 text-sm leading-relaxed">Open the cashier, process orders, and watch your
    ...
    <section id="download" class="py-24 bg-[#060b18]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="glass-dark rounded-3xl overflow-hidden relative">
                ...
                <div
                    class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-indigo-600/15 to-violet-600/10 rounded-full blur-3xl">
                </div>
                <div
                    class="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-emerald-600/10 to-teal-600/8 rounded-full blur-3xl">
                </div>
                ...
                <div class="relative z-10 grid lg:grid-cols-2 gap-12 p-10 lg:p-16 items-center">
                    ...
                    <div>
                        <div class="inline-flex items-center gap-2 glass rounded-full px-4 py-2 mb-6">
                            ...
                            <span class="text-xs font-semibold text-indigo-300 uppercase tracking-widest">Mobile
                                App</span>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <a href="#" class="store-btn">
                                <svg class="w-8 h-8 flex-shrink-0" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M3 3.5l10.5 6.5L18 7.5 5.6 3.7C4.5 3.3 3.4 3.8 3 4.2v-.7z" fill="#6ee7b7"
                                        opacity=".5" />
                                </svg>
                                <div>
                    ...
                    <div class="flex justify-center">
                        <div class="relative">
                            <!-- Phone frame -->
                            <div
                                class="w-64 h-auto glass-dark rounded-[3rem] p-3 shadow-2xl shadow-indigo-900/40 border border-white/10">
                                    ...
                                    <div class="px-4 pb-6 space-y-3">
                                        ...
                                        <div class="glass rounded-xl p-3">
                                            ...
                                            <div class="flex items-end gap-1 h-12">
                                                <div class="flex-1 rounded-t bg-indigo-500/40" style="height:40%">
                                                </div>
                                                <div class="flex-1 rounded-t bg-indigo-500/50" style="height:65%">
                                                </div>
                                                <div class="flex-1 rounded-t bg-indigo-500/60" style="height:50%">
                                                </div>
                                                <div class="flex-1 rounded-t bg-indigo-400/70" style="height:80%">
                                                </div>
                                                <div class="flex-1 rounded-t bg-indigo-400" style="height:60%"></div>
                                                <div class="flex-1 rounded-t bg-emerald-400" style="height:100%">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Nav bar -->
    ...
    <section class="py-24 bg-[#070c1b]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16">
                ...
                <p class="reveal text-slate-400 text-lg">Don't take our word for it — hear from the people who use it
                    daily.</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white font-bold text-sm">
                            AB</div>
                        <div>
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white font-bold text-sm">
                            SR</div>
                        <div>
                ...
                <div class="reveal glass rounded-3xl p-7 card-hover">
                    ...
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white font-bold text-sm">
                            DW</div>
                        <div>
    ...
    <section class="py-20 bg-[#060b18]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="reveal glass-dark rounded-3xl p-10 lg:p-14 overflow-hidden relative">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-emerald-600/8 via-indigo-600/6 to-violet-600/5 rounded-3xl">
                </div>
                ...
                <div class="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        <div
                            class="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full px-4 py-2 mb-6">
                            <i class="fas fa-gift text-emerald-400 text-sm"></i>
                            <span class="text-xs font-semibold text-emerald-300 uppercase tracking-wider">Free
                                Trial</span>
                        </div>
            ...
            <div class="grid md:grid-cols-3 gap-6 items-start">
                ...
                <div class="reveal glass rounded-3xl p-8 card-hover">
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> 1 Outlet</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Up to 3 Users</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> POS Module</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Basic Inventory</li>
                        <li class="flex items-center gap-3 text-sm text-slate-400"><i
                                class="fas fa-times text-slate-600 w-4"></i> Finance Module</li>
                        <li class="flex items-center gap-3 text-sm text-slate-400"><i
                                class="fas fa-times text-slate-600 w-4"></i> Advanced Reports</li>
                    </ul>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="block text-center py-3 rounded-2xl btn-secondary text-white text-sm font-semibold">Get
                            Started Free</a>
                    @endif
                </div>
                ...
                <div class="reveal glass pricing-popular rounded-3xl p-8 card-hover relative">
                    <div class="absolute -top-4 left-1/2 -translate-x-1/2">
                        <span
                            class="bg-gradient-to-r from-indigo-500 to-violet-600 text-white text-xs font-bold px-5 py-2 rounded-full shadow-lg shadow-indigo-500/30">MOST
                            POPULAR</span>
                    </div>
                    <div class="mb-6 mt-2">
                        <p class="text-sm font-semibold text-indigo-300 uppercase tracking-widest mb-1">Professional
                        </p>
                        <div class="flex items-end gap-1 mb-1">
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Up to 5 Outlets</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Unlimited Users</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Full POS Module</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Full Inventory</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Finance Module</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Advanced Reports</li>
                    </ul>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="block text-center py-3 rounded-2xl btn-primary text-white text-sm font-semibold">Start
                            14-Day Trial</a>
                    @endif
                </div>
                ...
                <div class="reveal glass rounded-3xl p-8 card-hover">
                    ...
                    <ul class="space-y-3 mb-8">
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Unlimited Outlets</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Unlimited Users</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> All Modules</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Multi-Tenant Setup</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Dedicated Support</li>
                        <li class="flex items-center gap-3 text-sm text-slate-300"><i
                                class="fas fa-check text-emerald-400 w-4"></i> Custom Integration</li>
                    </ul>
                    <a href="mailto:hello@posnerp.com"
                        class="block text-center py-3 rounded-2xl btn-secondary text-white text-sm font-semibold">Contact
                        Sales</a>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-[#070c1b]">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <div class="relative glass-dark rounded-3xl p-14 overflow-hidden">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-indigo-600/10 via-violet-600/8 to-emerald-600/6 rounded-3xl">
                </div>
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-slate-400 text-lg mb-10 max-w-xl mx-auto">
                        Join thousands of merchants already using {{ config('app.name') }}. Free to start, no credit
                        card required.
                    </p>
                    <div class="flex flex-wrap gap-4 justify-center">
                        ...
                        @else
                            ...
                            @endif
                            <a href="{{ route('login') }}"
                                class="btn-secondary text-slate-300 font-medium px-10 py-4 rounded-2xl text-lg flex items-center gap-2">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <p class="text-sm text-slate-500 leading-relaxed mb-5">The complete ERP & POS solution for modern
                        businesses, from single stores to nationwide franchises.</p>
                    <div class="flex gap-3">
                        <a href="#"
                            class="w-9 h-9 rounded-xl glass flex items-center justify-center text-slate-400 hover:text-white hover:bg-indigo-500/20 transition-all">
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="#features"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Features</a></li>
                        <li><a href="#modules"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Modules</a></li>
                        <li><a href="#pricing"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Pricing</a></li>
                        <li><a href="#download"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Download App</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="#" class="text-sm text-slate-500 hover:text-white transition-colors">About
                                Us</a></li>
                        <li><a href="#"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Careers</a></li>
                        <li><a href="#"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Blog</a></li>
                        <li><a href="#"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Contact</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2.5">
                        <li><a href="#"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Documentation</a>
                        </li>
                        <li><a href="#" class="text-sm text-slate-500 hover:text-white transition-colors">Help
                                Center</a></li>
                        <li><a href="#"
                                class="text-sm text-slate-500 hover:text-white transition-colors">Privacy Policy</a>
                        </li>
                        <li><a href="#" class="text-sm text-slate-500 hover:text-white transition-colors">Terms
                                of Service</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-sm text-slate-600">&copy; {{ date('Y') }} {{ config('app.name', 'POS ERP') }}. All
                    rights reserved.</p>
                <p class="text-sm text-slate-700 flex items-center gap-2">
                    Built with <i class="fas fa-heart text-red-500 text-xs"></i> on <a href="https://laravel.com"
                        target="_blank" class="text-indigo-400 hover:text-indigo-300">Laravel</a>
                </p>
            </div>
        </div>
    </footer>
