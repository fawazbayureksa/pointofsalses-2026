...
|--------------------------------------------------------------------------
|
| These routes are loaded for every tenant domain. Tenancy is initialized
| automatically via InitializeTenancyByDomain, so all DB queries hit the
| correct tenant database (e.g. tenantdemo).
|
*/
